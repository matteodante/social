...
const navigation = [
    ...
    { name: "Explore", href: "#", icon: HashtagIcon },
    { name: "Notifications", href: "#", icon: BellIcon },
    { name: "Messages", href: "#", icon: ChatBubbleOvalLeftIcon },
    { name: "Profile", href: "#", icon: UserIcon },
    { name: "Logout", href: "#", icon: ArrowRightOnRectangleIcon },
    { name: "Login", href: "#", icon: RocketLaunchIcon },
];
...
<template>
    ...
    <div class="bg-blue-900 isolate font-sans">
        <!-- NAVBAR MOBILE -->
                        ...
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <ul class="space-y-2 py-6">
                                ...
                                <li v-for="item in navigation" :key="item.name">
                                    <Link :href="item.href"
                                        class="flex items-center p-3 text-lg text font-bold text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <component class="h-8" :is="item.icon"></component>
        ...
        <div class="flex">
            ...
            <div class="w-2/5 text-white pl-32 py-4 h-auto">
                <!--left menu-->
            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
                ...
                <div class="pl-16">
                    <p class="text-base width-auto font-medium text-white flex-shrink">
                        ...
                        I was wondering what I can do with <span class="text-blue-400">#tailwindcss</span>, so just
            ...
            <div class="w-2/5 h-12">
                ...
                <div class="relative text-gray-300 w-80 p-5 pb-0 mr-16">
                    ...
                    <input type="search" name="search" placeholder="Search Twitter"
                        class="bg-blue-800 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow border-0">
