<template>
    ...
    <div class="relative text-white w-81 mt-3 ml-4 pb-0 mr-20">
        ...
        <input type="search" name="search" placeholder="Search"
            class="bg-black h-10 px-10 pr-5 w-full rounded-lg text-sm focus:border-light-100">
    ...
    <div class="max-w-sm rounded-lg bg-black border border-gray-600 overflow-hidden m-4 mr-20">
        <div class="flex">
            ...
            <div class="flex-1 px-4 py-2 m-2">
                <a href=""
                    class=" text-2xl rounded-full text-white hover:bg-light-800 hover:text-light-300 float-right">
                    <svg class="m-2 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex">
            ...
            <div class="flex-1 px-4 py-2 m-2">
                <a href=""
                    class=" text-2xl rounded-full text-gray-400 hover:bg-light-800 hover:text-light-300 float-right">
        ...
        <div class="flex">
            <div class="flex-1 p-4">
                <h2 class="px-4 ml-2 w-48 font-bold text-light-400">Show more</h2>
            </div>
        </div>
