...
const whoToFollow = [
    { name: 'Matteo Dante', username: 'matteodante98', bigPic: 'https://public.onlyfans.com/files/thumbs/w480/t/ts/tsa/tsa7xoik8vrc19riioeyfzh0vwoe8bdu1643338401/header.jpg', pic: 'https://pbs.twimg.com/profile_images/1121328878142853120/e-rpjoJi_bigger.png' },
...
<template>
    ...
    <div class="flex">
        <div class="flex-1 m-2">
            <h2 class="py-2 text-xl w-48 font-semibold text-white">Who to follow</h2>
        </div>
    </div>


    <WhoToFollowWidgetLinkBig v-for="who in whoToFollow" :name="who.name" :username="who.username" :pic="who.pic"
        :bigPic="who.bigPic" />
